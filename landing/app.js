...
const SIMULATIONS = [
  ...
  { chapter: '8', chapterName: 'Physics of Matter', topic: '8.4', title: 'Thermal Expansion', description: 'Track linear, area, and volume expansion alongside liquid-in-container overflow.', outcome: 'Expansion coefficients α, β = 2α, γ = 3α, and container overflow.', status: 'completed', href: '../animations/08-physics-of-matter/8.4-thermal-expansion/index.html', visual: 'expansion' },
  { chapter: '9', chapterName: 'Kinetic Theory of Gases and Thermodynamics', topic: '9.1–9.2', title: 'Molecular Gas Laboratory', description: 'Connect a projected molecular sample to rms speed, pressure, equipartition, and internal energy.', outcome: 'Kinetic-theory assumptions, rms speed, gas pressure, molecular kinetic energy, and internal energy.', status: 'completed', href: '../animations/09-kinetic-theory-and-thermodynamics/9.1-9.2-molecular-gas-lab/index.html', visual: 'molecular' }
];
...
function visualSvg(type) {
  ...
  const diagrams = {
    ...
    molecular: `${DIAGRAM.path('M8 12 H75 V62 H8 Z', 'secondary')}${DIAGRAM.particle(20, 24, 3)}${DIAGRAM.particle(37, 48, 3)}${DIAGRAM.particle(56, 29, 3)}${DIAGRAM.particle(65, 51, 3)}${DIAGRAM.arrow(20, 24, 32, 18, 'primary', markers)}${DIAGRAM.arrow(37, 48, 48, 39, 'primary', markers)}${DIAGRAM.arrow(56, 29, 67, 35, 'primary', markers)}${DIAGRAM.axis(85, 61, 114, 61, markers)}${DIAGRAM.axis(85, 61, 85, 16, markers)}${DIAGRAM.path('M88 55 L94 49 L100 38 L106 27 L112 17')}${DIAGRAM.label('v²', 88, 13, 'start')}`,
...
function cardTemplate(sim) {
  ...
  const hasStandaloneDiagram = ['trajectory', 'orbit', 'oscillation', 'graph', 'wave', 'superposition', 'standing', 'doppler', 'materials', 'conduction', 'expansion', 'molecular', 'planned'].includes(sim.visual);
