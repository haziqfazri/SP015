...
const SIMULATIONS = [
  ...
  { chapter: '8', chapterName: 'Physics of Matters', topic: '8.1–8.2', title: 'Materials Testing', description: 'Load a specimen to explore stress, strain, Young\'s modulus, and ductile versus brittle behavior.', outcome: 'Stress, strain, Hooke\'s law, Young\'s modulus, and elastic strain energy.', status: 'completed', href: '../animations/08-physics-of-matters/8.1-8.2-materials-testing/index.html', visual: 'materials' },
  { chapter: '8', chapterName: 'Physics of Matters', topic: '8.3', title: 'Heat Conduction', description: 'Model steady-state 1D heat transfer through series conductors and inspect temperature gradients.', outcome: 'Rate of heat transfer, series thermal resistance, and insulated versus non-insulated profiles.', status: 'planned', href: null, visual: 'conduction' },
  { chapter: '8', chapterName: 'Physics of Matters', topic: '8.4', title: 'Thermal Expansion', description: 'Track linear, area, and volume expansion alongside liquid-in-container overflow.', outcome: 'Expansion coefficients α, β = 2α, γ = 3α, and container overflow.', status: 'planned', href: null, visual: 'expansion' }
];
