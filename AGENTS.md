...
8. **Wire theory strip / readouts** to LO text and correct units. Cross-check against `Curriculum Specifications (CS) Physics SP015.pdf`.
...
- **Physics:** Equations match `Curriculum Specifications (CS) Physics SP015.pdf`. Every equation cited with LO. Derived quantities are getters. `dt` is clamped. Simplifications stated.
