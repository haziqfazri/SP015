...
curriculum specification (SP015 in `Curriculum Specifications (CS) Physics SP015.pdf` at the repo
...
8. **Wire the theory strip / readouts** to match the LO text and correct
   units, cross-checking against `Curriculum Specifications (CS) Physics SP015.pdf`.
